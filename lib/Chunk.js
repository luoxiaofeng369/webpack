 ...
 * @return {-1|0|1} - The order number of the sort
 */
...
/**
 * @return {string} a concatenation of module identifiers sorted
 ...
 * @return {Array} the array returned from Array.from(set)
 */
const getArray = set => Array.from(set);

/**
 * @param {Set<Module>} set the Set to get the count/size of
 * @return {number} the size of the modules
 */
...
class Chunk {
	 ...
	 * @return {-1|0|1} this is a comparitor function like sort and returns -1, 0, or 1 based on sort order
	 */
	 ...
	 * @return {boolean} returns true if module does exist in this chunk
	 */
	 ...
	 * @return {boolean} returns true or false if integration succeeds or fails
	 */
	 ...
	 * @return {number} the multiplier returned
	 */
	...
	/**
	 * @return {number} the size of all modules
	 */
	modulesSize() {
	 ...
	 * @return {boolean} return true if module exists in graph
	 */
